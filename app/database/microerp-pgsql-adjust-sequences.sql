...
SELECT setval('orcamento_produtos_id_seq', coalesce(max(id),0) + 1, false) FROM orcamento_produtos;
SELECT setval('orcamento_servicos_id_seq', coalesce(max(id),0) + 1, false) FROM orcamento_servicos;
