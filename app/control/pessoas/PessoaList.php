...
class PessoaList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de gerenciar");
        $this->limit = 20;
        ...
        $id_busca_header = new TEntry('id_busca_header');
        $tipo_cliente_id_busca_header = new TDBCombo('tipo_cliente_id_busca_header', 'microerp', 'TipoPessoa', 'id', '{nome}','nome asc'  );

        $id_busca_header->exitOnEnter();

        $id_busca_header->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1']));

        $tipo_cliente_id_busca_header->setChangeAction(new TAction([$this, 'onSearch'], ['static'=>'1']));

        $tipo_cliente_id->enableSearch();
        $tipo_cliente_id_busca_header->enableSearch();
        ...
        $row2 = $this->form->addFields([new TLabel("Documento:", null, '14px', null, '100%'),$documento],[new TLabel("Telefone:", null, '14px', null, '100%'),$telefone],[new TLabel("Email:", null, '14px', null, '100%'),$email]);
        ...
        $column_tipo_cliente_nome = new TDataGridColumn('tipo_cliente->nome', "Tipo do cliente", 'left');
        ...
        $tr->add(TElement::tag('td', ''));
        $tr->add(TElement::tag('td', ''));
        $td_id_busca_header = TElement::tag('td', $id_busca_header);
        $tr->add($td_id_busca_header);
        $td_tipo_cliente_id_busca_header = TElement::tag('td', $tipo_cliente_id_busca_header);
        $tr->add($td_tipo_cliente_id_busca_header);
        ...
        $this->datagrid_form->addField($id_busca_header);
        $this->datagrid_form->addField($tipo_cliente_id_busca_header);
        ...
        $panel = new TPanelGroup("Listagem de gerenciar");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Pessoas","Gerenciar"]));
        }
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->id_busca_header) AND ( (is_scalar($data->id_busca_header) AND $data->id_busca_header !== '') OR (is_array($data->id_busca_header) AND (!empty($data->id_busca_header)) )) )
        {

            $filters[] = new TFilter('id', '=', $data->id_busca_header);// create the filter 
        }

        if (isset($data->tipo_cliente_id_busca_header) AND ( (is_scalar($data->tipo_cliente_id_busca_header) AND $data->tipo_cliente_id_busca_header !== '') OR (is_array($data->tipo_cliente_id_busca_header) AND (!empty($data->tipo_cliente_id_busca_header)) )) )
        {

            $filters[] = new TFilter('tipo_cliente_id', '=', $data->tipo_cliente_id_busca_header);// create the filter 
        }
