...
class CidadeHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $id = new TEntry('id');
        $estado_id = new TDBCombo('estado_id', 'microerp', 'Estado', 'id', '{nome}','nome asc'  );
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['CidadeHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['CidadeHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        ...
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['CidadeHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Pessoas","Cidades"]));
        }
