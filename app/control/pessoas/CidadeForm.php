...
class CidadeForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome],[new TLabel("Codigo ibge:", '#ff0000', '14px', null, '100%'),$codigo_ibge]);
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['CidadeHeaderList', 'onShow']), 'fas:arrow-left #000000');
