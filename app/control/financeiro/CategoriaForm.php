...
class CategoriaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $tipo_conta_id = new TDBCombo('tipo_conta_id', 'microerp', 'TipoConta', 'id', '{nome}','nome asc'  );
        $nome = new TEntry('nome');

        $tipo_conta_id->addValidation("Tipo de conta", new TRequiredValidator()); 
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Tipo de conta:", '#ff0000', '14px', null, '100%'),$tipo_conta_id]);
