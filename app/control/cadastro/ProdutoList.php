...
class ProdutoList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Tipo de produto:", null, '14px', null, '100%'),$tipo_produto_id],[new TLabel("Nome:", null, '14px', null, '100%'),$nome]);
        ...
        $column_preco_transformed = new TDataGridColumn('preco', "Preço", 'left');
        $column_foto_transformed = new TDataGridColumn('foto', "Foto", 'left');
        ...
        $column_foto_transformed->setTransformer(function($value, $object, $row, $cell = null, $last_row = null)
        {

            if (file_exists($value)) 
            {
                $img = new TImage($value);
        ...
        $this->datagrid->addColumn($column_foto_transformed);
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Cadastro","Produtos"]));
        }
