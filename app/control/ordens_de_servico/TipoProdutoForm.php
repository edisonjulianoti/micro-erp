...
class TipoProdutoForm extends TPage
{
    ...
    private static $formName = 'form_TipoProdutoForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de tipo produto");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['TipoProdutoHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('TipoProdutoHeaderList', 'onShow', $loadPageParam); 
