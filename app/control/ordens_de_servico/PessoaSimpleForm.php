...
class PessoaSimpleForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_PessoaSimpleForm';
    ...
    public function __construct( $param )
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Tipo do cliente:", '#ff0000', '14px', null, '100%'),$tipo_cliente_id]);
