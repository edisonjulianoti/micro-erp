...
class Solucao extends TRecord
{
    ...
    public function getOrdemServicoAtendimentos()
    {
        ...
        $criteria->add(new TFilter('solucao_id', '=', $this->id));
    ...
    public function get_ordem_servico_atendimento_tecnico_to_string()
    {
        ...
        $values = OrdemServicoAtendimento::where('solucao_id', '=', $this->id)->getIndexedArray('tecnico_id','{tecnico->nome}');
    ...
    public function get_ordem_servico_atendimento_ordem_servico_to_string()
    {
        ...
        $values = OrdemServicoAtendimento::where('solucao_id', '=', $this->id)->getIndexedArray('ordem_servico_id','{ordem_servico->id}');
        return implode(', ', $values);
    }
    ...
    public function get_ordem_servico_atendimento_solucao_to_string()
    {
        ...
        $values = OrdemServicoAtendimento::where('solucao_id', '=', $this->id)->getIndexedArray('solucao_id','{solucao->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_ordem_servico_atendimento_causa_to_string()
    {
        ...
        $values = OrdemServicoAtendimento::where('solucao_id', '=', $this->id)->getIndexedArray('causa_id','{causa->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_ordem_servico_atendimento_problema_to_string()
    {
        ...
        $values = OrdemServicoAtendimento::where('solucao_id', '=', $this->id)->getIndexedArray('problema_id','{problema->nome}');
        return implode(', ', $values);
    }
